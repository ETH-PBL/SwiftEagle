...
#
# edit_axi_to_16_registers_v1_0.tcl: Tcl script for re-creating project 'edit_axi_to_16_registers_v1_0'
#
# Generated by Vivado on Wed Mar 08 09:19:07 CET 2023
...
#
# 1. This project restoration tcl script (edit_axi_to_16_registers_v1_0.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "./sources/hdl/axi_to_16_registers_v1_0_S00_AXI.v"
#    "./sources/hdl/axi_to_16_registers_v1_0.v"
#
# 3. The following remote source files that were added to the original project:-
#
#    "./ip_designs/axi_to_16_registers/ip_package/component.xml"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/sources/hdl/axi_to_16_registers_v1_0_S00_AXI.v"]"\
 "[file normalize "$origin_dir/sources/hdl/axi_to_16_registers_v1_0.v"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/ip_package/component.xml"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set _xil_proj_name_ "edit_axi_to_16_registers_v1_0"
...
set script_file "edit_axi_to_16_registers_v1_0.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/edit_axi_to_16_registers_v1_0"]"
...
set file "$origin_dir/ip_package/component.xml"
...
set file "hdl/axi_to_16_registers_v1_0_S00_AXI.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "hdl/axi_to_16_registers_v1_0.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "axi_to_16_registers_v1_0" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "/home/rothmi/michael-roth/software/vivado_ws/ip_repo/edit_axi_to_16_registers_v1_0.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "/home/rothmi/michael-roth/software/vivado_ws/ip_repo/edit_axi_to_16_registers_v1_0.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "/home/rothmi/michael-roth/software/vivado_ws/ip_repo/edit_axi_to_16_registers_v1_0.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
